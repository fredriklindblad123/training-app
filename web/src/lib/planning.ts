...
// Period + fas — samma tvånivå-vokabulär som rad 5-6 i Säsongsöversikt-fliken i
...
export type TemplateItem = {
  ...
  /** Vilken Säsongsöversikt-rad (lib/training-factors.ts) det här passet räknas mot
   ...
   * Säsongsöversikt-flik härleds numera ur vilka pass som faktiskt är taggade med
