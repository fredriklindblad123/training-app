...
/* Excel-export: Flerårsplan, Säsongsöversikt och (sedan 2026-08-21) Blockplan — de
 ...
 * /sasongsoversikt tills vidare, uttryckligt val 2026-08-21. Radetiketterna speglar
 * originalmallens rubriker men det här är en ny arbetsbok, inte en ifylld
 * kopia av källfilen.
 *
 * Säsongsöversikt-fliken byggs sedan 2026-08-17 ur lib/arsplan-grid.ts och
 * Blockplan-fliken ur lib/blockplan-grid.ts — samma datamoduler som
 * /sasongsoversikt och /blockplan använder in-app, så Excel-filen och appvyerna
...
function buildArsplanSheet(
  ...
  const sheet = workbook.addWorksheet("Säsongsöversikt");
 ...
 * rader för samma data"-princip som Säsongsöversikt-fliken redan följer. */
...
export async function GET(request: Request) {
  ...
  // löpare vars block skapats av en coach; /sasongsoversikt-sidan gjorde redan rätt.
