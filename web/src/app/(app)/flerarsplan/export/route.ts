...
/* Excel-export: Flerårsplan, Årsöversikt och (sedan 2026-08-21) Blockplan — de
 ...
 * /arsoversikt tills vidare, uttryckligt val 2026-08-21. Radetiketterna speglar
 * originalmallens rubriker men det här är en ny arbetsbok, inte en ifylld
 * kopia av källfilen.
 *
 * Årsöversikt-fliken byggs sedan 2026-08-17 ur lib/arsplan-grid.ts och
 * Blockplan-fliken ur lib/blockplan-grid.ts — samma datamoduler som
 * /arsoversikt och /blockplan använder in-app, så Excel-filen och appvyerna
...
function buildArsplanSheet(
  ...
  const sheet = workbook.addWorksheet("Årsöversikt");
 ...
 * rader för samma data"-princip som Årsöversikt-fliken redan följer. */
...
export async function GET(request: Request) {
  ...
  // löpare vars block skapats av en coach; /arsoversikt-sidan gjorde redan rätt.
