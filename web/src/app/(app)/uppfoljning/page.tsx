 ...
 * lib/range-stats.ts är exakt samma funktion som /arsoversikt visar sin
 ...
 * Årsöversikt får aldrig visa olika siffror, eftersom det är samma kod på samma
...
export default async function UppfoljningPage({
   ...
   * URL-param-mönster som /arsoversikt och /tavlingsresultat redan använder. */
    ...
    <div className="flex flex-1 flex-col gap-8 px-6 py-8">
      <div>
        ...
        <p className="mt-1 max-w-3xl text-sm text-[var(--ink-2)]">
          ...
          gjorda och hur de fördelade sig. Samma uträkning som blockstatistiken på Årsöversikt, så
      ...
      {period && rows.length > 0 && (
        <>
          ...
          {/* Fördelning per passtyp — samma chip-form och samma
              kategorifärger (workoutTypeColorVar) som Årsöversikts
