 ...
 * pass, repgrupper) hör numera till /blockplan, se den filens actions.ts. */
 ...
 * man slipper hoppa till Blockplan bara för att komma igång. Rubrik,
 * mål-tid/distans och repgrupper per pass fylls i sedan på Blockplan —
