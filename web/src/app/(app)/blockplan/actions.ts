 ...
 * tillgänglighet hör till /arsoversikt, se den filens actions.ts. */
 ...
 * mönstret självt görs det på /arsoversikt där blocket bor.) */
 ...
 * av med det permanent ändras standardveckan på /arsoversikt. */
