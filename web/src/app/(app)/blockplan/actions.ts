 ...
 * tillgänglighet hör till /blockoversikt, se den filens actions.ts. */
 ...
 * mönstret självt görs det på /blockoversikt där blocket bor.) */
 ...
 * av med det permanent ändras standardveckan på /blockoversikt. */
